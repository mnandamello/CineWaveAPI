        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarketingChanne = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActived = table.Column<bool>(type: "NUMBER(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Insights",
                columns: new[] { "Id", "AverageCostPerClick", "ConversionPrediction", "MarketingChanne", "MovieTitle", "RoiForecast" },
                values: new object[,]
                {
